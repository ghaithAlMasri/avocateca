  ...
  return (
    ...
    >
      ...
      >
        ...
        whileInView = {{ opacity:1, rotate: [-180, 0], scale: [0.5,1,1.2,1], transition: {duration: 0.2, type: "spring", stiffness: 150, damping: 20} }}
        ...
        <motion.div
        initial={{ scale: 0, opacity: 0 }}
        whileInView = {{ opacity:1, rotate: [-180, 0], scale: [0.5,1,1.2,1], transition: {duration: 0.2, type: "spring", stiffness: 150, damping: 20, delay: 0.2} }}
        >
        ...
        <motion.div
        initial={{ scale: 0, opacity: 0 }}
        whileInView = {{ opacity:1, rotate: [-180, 0], scale: [0.5,1,1.2,1], transition: {duration: 0.2, type: "spring", stiffness: 150, damping: 20, delay: 0.4} }}
        ...
        <motion.div
        initial={{ scale: 0, opacity: 0 }}
        whileInView = {{ opacity:1, rotate: [-180, 0], scale: [0.5,1,1.2,1], transition: {duration: 0.2, type: "spring", stiffness: 150, damping: 20, delay: 0.6} }}
